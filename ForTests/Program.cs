...
namespace ForTests
{
    class Program
    {
        ...
        {
            var IngridientSearch = SearchingByRecipe(586662).GetAwaiter().GetResult();
            var recipe = IngridientSearch.extendedIngredients;
            ...
            Console.WriteLine("\nSummmary:");
            Console.WriteLine(IngridientSearch.summary);

            Console.WriteLine("\nInstructions:");
            Console.WriteLine(IngridientSearch.instructions);

            Console.WriteLine("\nAnalyzed instructions:");
            var instructions = IngridientSearch.analyzedInstructions;
